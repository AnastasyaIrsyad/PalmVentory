...
import { PackageX, X, Loader2, ShieldAlert } from "lucide-react";

// Pop-up di tengah layar saat Supplier menekan tombol "Tolak" pada salah satu
// baris permintaan di halaman Kelola Pesanan. Alasan penolakan wajib diisi
// di dalam pop-up ini (tidak lagi ditampilkan inline di baris tabel).
export default function RejectPesananModal({ item, onClose, onConfirm, submitting }) {
      ...
      >
        <div className="bg-[#4A151E] px-5 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2 text-white">
            <ShieldAlert size={18} />
            <span className="text-sm font-black uppercase tracking-wide">Tolak Permintaan</span>
          </div>
        ...
        <div className="p-6 space-y-4">
          <p className="text-sm text-gray-500">
            Anda akan menolak permintaan barang berikut dari admin:
          </p>
          ...
          <div className="text-left space-y-2">
            ...
            <textarea
              ...
              rows={3}
              placeholder="Contoh: Stok barang sedang kosong / tidak sesuai spesifikasi"
              autoFocus
          ...
          <div className="flex gap-3 pt-1">
            ...
            >
              {submitting ? <Loader2 size={15} className="animate-spin" /> : <PackageX size={15} />}
              Konfirmasi Tolak
            </button>
          </div>
        </div>
